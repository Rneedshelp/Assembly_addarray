...
;  Project files: sum-driver.cpp, sum-array.asm
;Module information
;  This module's call name: sum
;  Language: X86-64
;  Syntax: Intel
;  Date last modified: 2016-Nov-01 [Fill in the correct date here]
;  Purpose: This module will compute the sum of 64-bit doubles stored in an array.
;  File name: sum-array.asm
;  Status: This module was developed quickly and needs a well-designed test plan
;  Future enhancements: Yes.  Students in CPSC254 will debug this function (module).
...
;  Linux: nasm -f elf64 -l sum-array.lis -o sum-array.o sum-array.asm
;References and credits
;  Seyfarth, Chapter 11
;Safe programming practices employed: contamination free
;  No proprietary tools were employed in the development of this software.
;Format information
...
pop        rbp                                               ;Return to rbp the value it had in the function that called this assembly function.
ret                                                          ;Pop the stack into the rip register which is the register of the next instruction.
